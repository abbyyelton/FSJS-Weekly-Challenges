...
//When mouse hovers over card, show answer
$(".flash-card").hover( function() {
  $(this).children(".answer" ).show();
},
//When mouse leaves card, hide answer
  function() {
    if ( ($(this).next().children(".answer").css("display") === "none") || ($(this).prev().children(".answer").css("display") === "none") ) {
